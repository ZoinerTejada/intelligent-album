...
{
    [Serializable]
    internal class PicturesOfFriendDialog : IDialog<string>
    {
        private int _attempts = 3;

        public async Task StartAsync(IDialogContext context)
        {
            await context.PostAsync($"What's your friend's name?");
        ...
        public virtual async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> result)
        {
            ...
            else
            {
                ...
                if (_attempts > 0)
                {
                    await context.PostAsync("I'm sorry, I don't understand your reply. What is your friend's name?");
